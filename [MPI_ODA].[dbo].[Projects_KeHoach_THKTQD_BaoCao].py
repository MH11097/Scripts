...
def main():
    ...
    DatabaseSrc = 'MPI_ODA'
    table_Src = 'Projects_KeHoach_BaoCao'

    # Des_info
    ServerDes = '10.2.6.20,1433'
    UIDDes = 'edsolabs'
    PWDDes = 'axz@312'
    DatabaseDes = 'MPI_ODA_MART_21'
    table_Des = 'Projects_KeHoach_BaoCao_hieulm'
    ...
    logging.basicConfig(filename="[MPI_ODA].[dbo].[Projects_KeHoach_THKTQD_BaoCao]/"+time.strftime(r"%Y-%m-%d %H-%M-%S", time.localtime())+".log",
